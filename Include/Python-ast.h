...
enum _expr_kind {BoolOp_kind=1, NamedExpr_kind=2, BinOp_kind=3, IncOp_kind=4,
                  UnaryOp_kind=5, Lambda_kind=6, IfExp_kind=7, Dict_kind=8,
...
expr_ty _Py_BinOp(expr_ty left, operator_ty op, expr_ty right, int lineno, int
                  col_offset, int end_lineno, int end_col_offset, PyArena
                  *arena);
#define IncOp(a0, a1, a2, a3, a4, a5) _Py_IncOp(a0, a1, a2, a3, a4, a5)
expr_ty _Py_IncOp(expr_ty right, int lineno, int col_offset, int end_lineno,
                  int end_col_offset, PyArena *arena);
